/**
 * @namespace lcsCountries
 * @description
 * An object containing detailed information about countries around the world, including region codes, continent codes, capital cities, time zones, calling codes, and currency details.
 * 
 * This object is intended for use in applications that require structured, country-specific information such as region, currency, and calling codes.
 * 
 * @property {Object} country_code - Each property of `lcsCountries` represents a country by a unique identifier (lowercase country name with underscores). 
 *                                    Each country's object contains detailed properties about that country.
 * 
 * @property {string} country_code.ip - Reserved for IP address or related data specific to the country.
 * @property {string} country_code.name - The full name of the country (e.g., "Afghanistan").
 * @property {string} country_code.region_code - The ISO 3166-1 alpha-2 region code for the country (e.g., "AF" for Afghanistan).
 * @property {string} country_code.continent_code - The continent code where the country is located (e.g., "AS" for Asia).
 * @property {string} country_code.country_capital - The capital city of the country (e.g., "Kabul").
 * @property {string} country_code.timezone - The primary timezone of the country, typically the capital city's timezone (e.g., "Asia/Kabul").
 * @property {string} country_code.calling_code - The country calling code used for international dialing (e.g., "93" for Afghanistan).
 * 
 * @property {Object} country_code.currency - An object describing the country's currency details.
 * @property {string} country_code.currency.label - The name of the country's currency (e.g., "afghani" for Afghanistan).
 * @property {string} country_code.currency.sign - The symbol of the currency used in the country (e.g., "؋" for Afghan afghani).
 * 
 * @example
 * // Accessing details of Afghanistan
 * const afghanistan = lcsCountries.afghanistan;
 * console.log(afghanistan.name); // "Afghanistan"
 * console.log(afghanistan.currency.sign); // "؋"
 */
const lcsCountries = {
    "afghanistan": {
      "ip": "",
  ...
  "sri_lanka": {
    ...
    "region_code": "LK",
    "continent_code": "AS",
    "country_capital": "Sri Jayawardenepura Kotte",
